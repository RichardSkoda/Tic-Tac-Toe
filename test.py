...
while True:
    ...
    check_draw_horizontal = check_draw.diagonal_left_top_to_right_bottom(player_one_symbol)
    ...
    # check draw player two
    check_draw_vertical = check_draw.diagonal_left_top_to_right_bottom(player_one_symbol)
    ...
    if check_diagonal_line == symbol_in_row_to_win:
        ...
        break
            ...
            # check draw player two
    check_draw_diagonal_right = check_draw.diagonal_left_top_to_right_bottom(player_one_symbol)
